The goal of this assignment was to create a real world example with a provided database. Using the real world example you would then use the information to create a detailed report.
